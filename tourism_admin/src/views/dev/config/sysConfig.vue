	...
	<a-spin :spinning="loadSpinning">
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical" :label-col="labelCol">
			...
			<a-row :gutter="16">
				...
				<a-col :span="8">
          <a-form-item label="消息通知" name="SNOWY_BIZ_NOTICE">
						<a-input v-model:value="formData.SNOWY_BIZ_NOTICE" placeholder="请输入系统默认密码" />
					</a-form-item>
				</a-col>
			</a-row>
      <a-row :gutter="16">
				...
				<a-col :span="8"> 
					<a-form-item label="关于我们" name="SNOWY_BIZ_ABOUT">
            <editor v-model="formData.SNOWY_BIZ_ABOUT" :file-upload-function="apiFunction.fileUploadApi" />
					</a-form-item>
				</a-col>
				<a-col :span="8">
					<a-form-item label="景区概况" name="SNOWY_BIZ_SPOT">
						<editor v-model="formData.SNOWY_BIZ_SPOT" :file-upload-function="apiFunction.fileUploadApi" />
					</a-form-item>
				</a-col>
			</a-row>
			<a-row :gutter="16">
...
<script setup name="sysConfig">
	...
	import fileApi from '@/api/dev/fileApi.js'
