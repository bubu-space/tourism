package com.snowy.client.modular.wxindex.controller;
...
import com.snowy.client.modular.wxplan.result.newplan;
...
import com.snowy.dev.modular.config.provider.DevConfigApiProvider;
...
public class WxIndexControll {
    ...
    public CommonResult<List<BizRecommend>> getRecommend(String type) {
        List<BizRecommend> list = bizRecommendService.lambdaQuery().eq(BizRecommend::getCategory,type).last("limit 200").list();
